...
![Histogram of total steps taken each day](./figure/plot1.png)
...
![Time series plot of average steps taken](./figure/plot2.png)
```{r, echo=TRUE}
...
![Histogram of total steps taken each day](./figure/plot3.png)
```{r, echo=TRUE}
